<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProductsManage_PreservedFlowe.aspx.cs" Inherits="Back_ProductsManage_PreservedFlowe" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

    <title>商品管理---永生花</title>
    ...
    <div class="P-content">
        ...
        <div class="P-con-left">
            ...
            <div class="P-con-left-item">
                ...
                <p>
                    <asp:HyperLink ID="HyperLink8" runat="server" ForeColor="#FF6A00">永生花</asp:HyperLink>
                </p>
                <p>
