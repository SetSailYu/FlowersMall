...
public partial class Back_ProductsManage_PreservedFlowe : System.Web.UI.Page
{
    ...
    {
        DB db = new DB();
        string sql = "SELECT DISTINCT * FROM [Commodity_Table] WHERE c_kind='永生花' ORDER BY [c_series]";
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if ((e.Row.RowState & DataControlRowState.Edit) != 0)
            {
                ...
                sexddl.Items.Add("永生瓶花");
                sexddl.Items.Add("经典花盒");
                sexddl.Items.Add("巨型玫瑰");
                sexddl.Items.Add("特色永生花");
                sexddl.Items.Add("薰衣草");
