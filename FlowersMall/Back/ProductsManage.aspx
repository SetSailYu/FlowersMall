<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProductsManage.aspx.cs" Inherits="Back_ProductsManage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

    <title>商品管理---鲜花系列</title>
    ...
    <div class="P-content">
        ...
        <div class="P-con-left">
            ...
            <div class="P-con-left-item">
                ...
                <p>
                    <asp:HyperLink ID="HyperLink7" runat="server" ForeColor="#FF6A00">鲜花系列</asp:HyperLink>
                </p>
                <p>
