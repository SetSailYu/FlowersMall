<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Gift.aspx.cs" Inherits="Front_Gift" %>
            ...
            <div class="FF-slideshow">
                <div class="center-left-img">
                    ...
                    <div class="imgBox">
                        ...
                        <div class="fill" style="background-image:url('../Images/17.jpg')"></div>
                            </asp:HyperLink>
                        </div>
                        <div class="img-slide ">
                        ...
                        <ItemTemplate>
                            <div class="F-Show-grid">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <asp:HyperLink ID="HyperLink8" CssClass="F-Show-operate" runat="server">
