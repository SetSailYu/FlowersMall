...
(
    a_id INT NOT NULL,
    --用户id
    a_address [VARCHAR](50) NOT NULL,--收货地址
    a_name [NVARCHAR](10) NOT NULL,--收货人
    a_iphone [VARCHAR](10) NOT NULL,--收货手机号
...
(
    ...
    c_name [NVARCHAR](30) NOT NULL,--商品名
    c_series [NVARCHAR](10) ,--系列,细分的用途
    c_kind [NVARCHAR](10) NOT NULL,--种类, 鲜花永生花,礼盒
    c_flower_language [NVARCHAR](50) NOT NULL,--花语
    c_flower_material [NVARCHAR](30) NOT NULL,--花材
...
(
    ...
    o_a_address INT NULl,--收货地址
    o_a_name [NVARCHAR](10) NOT NULL,--收货人
    o_a_iphone [VARCHAR](10) NOT NULL,--收货手机号
